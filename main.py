...
def main(folder_path):
    ...
    for file_name in os.listdir(folder_path):
        if file_name.endswith('.pdf'):
            ...
            monitor_performance(process_pdf, file_path)

if __name__ == "__main__":
    folder_path = 'H:\\AiInternTask\\format-corpus-master\\format-corpus-master\\pdfCabinetOfHorrors'  # Update this to your PDF folder path
    main(folder_path)
